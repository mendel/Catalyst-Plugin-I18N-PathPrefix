...
Catalyst::Plugin::LanguagePrefix - The great new Catalyst::Plugin::LanguagePrefix!
...
Perhaps a little code snippet.
    ...
    use Catalyst::Plugin::LanguagePrefix;

    my $foo = Catalyst::Plugin::LanguagePrefix->new();
    ...
...
Please report any bugs or feature requests to C<bug-catalyst-plugin-languageprefix at rt.cpan.org>, or through
the web interface at L<http://rt.cpan.org/NoAuth/ReportBug.html?Queue=Catalyst-Plugin-LanguagePrefix>.  I will be notified, and then you'll
